...
icon = Image.open("Youtube-logo.jpg")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | Santhana Krishnan",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Santhana Krishnan*"""})
...
mydb = sql.connect(host="localhost",
                   user="root",
                   password="mysql@50345034",
                   database= "youtube_db"
                  )
mycursor = mydb.cursor(buffered=True)

# BUILDING CONNECTION WITH YOUTUBE API
api_key = "AIzaSyDK0FTK6oiuG-HpNwZBfRXLi8I31UpheiM"
